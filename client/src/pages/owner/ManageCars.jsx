          ...
          <div className='max-w-3xl w-full rounded-md overflow-hidden border border-borderColor mt-6'>
              ...
              <table className='w-full border-collapse text-left text-sm text-gray-600'>
                  <thead className='text-gray-500'>
                      <tr>
                          <td className='p-3 font-medium'>Cars</td>
                          <td className='p-3 font-medium max-md:hidden'>Category</td>
                          ...
                          <tr key={index} className='border border-borderColor'>
                              <td className='p-3 flex items-center gap-3'>
                                  ...
                                  <div className='max-md:hidden'>
                                      ...
                                      <p className='text-xs text-gray-500'>{car.seatung_capacity} • { car.transmission}</p>
                                  </div>
                              </td> 
                              ...
                              <td className='p-3 max-md:hidden'>
                                  <span className={`px-3 py-1 rounded-full text-xs ${car.isAvaliable ? "bg-green-100 text-green-500" : "bg-red-100 text-red-500"}`}>
                                     {car.isAvaliable ? "Availiable" : "Unavaliable"}
                                  </span>                                 
                              </td>
