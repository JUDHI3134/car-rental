          ...
          initial={{scale: 0.95, y: 50, opacity: 0 }}
            ...
            transition={{duration: 0.6, delay: 0.4}}
              ...
              <div className='flex flex-col items-start gap-2'>
                  ...
                  <input onChange={e => setPickupDate(e.target.value)} value={pickupDate} type="date" name="" id="pickup-date" min={new Date().toISOString().split('T')[0]} className='text-sm text-gray-500' />
              </div>

              <div className='flex flex-col items-start gap-2'>
                  <label htmlFor="return-date">Return Date</label>
                  <input onChange={e => setReturnDate(e.target.value)} value={returnDate} type="date" name="" id="return-date" className='text-sm text-gray-500' />
              </div>
              </div>
