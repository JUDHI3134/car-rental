  ...
  return (
      ...
      transition={{duration: 1, delay: 0.5}}
          ...
          <motion.button
              ...
              onClick={() => { navigate("/cars"); scrollTo(0, 0) }} className='flex items-center justify-center gap-2 px-6 py-2 border border-borderColor hover:bg-gray-50 rounded-lg mt-18 cursor-pointer'>
